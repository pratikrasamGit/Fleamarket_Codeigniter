...
class Rudra_settings_rudra_model extends CI_Model
                
{
	...
	$query = " SELECT TBL.id, TBL.st_key, TBL.st_meta, TBL.dnk_meta, TBL.status, TBL.is_deleted" ;
	$query .= "  FROM $table "; 
	$where = " WHERE 1 = 1 ";
	 $where .= " AND ( ";
	$where .=  "  TBL.id LIKE '%".$filter_data['general_search']."%'";
	$where .=  "  OR  TBL.st_key LIKE '%".$filter_data['general_search']."%'";
	$where .=  "  OR  TBL.st_meta LIKE '%".$filter_data['general_search']."%'";
	$where .=  "  OR  TBL.dnk_meta LIKE '%".$filter_data['general_search']."%'";
