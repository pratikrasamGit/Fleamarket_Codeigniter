...
class Rudra_purchased_history_rudra_model extends CI_Model
                
{
	...
	$query = " SELECT TBL.id, TBL.fk_user_id, TBL.fk_purchased_id, TBL.fk_type" ;
	$query .= "  FROM $table "; 
	$where = " WHERE 1 = 1 ";
	 $where .= " AND ( ";
	$where .=  "  TBL.id LIKE '%".$filter_data['general_search']."%'";
	$where .=  "  OR  TBL.fk_user_id LIKE '%".$filter_data['general_search']."%'";
	$where .=  "  OR  TBL.fk_purchased_id LIKE '%".$filter_data['general_search']."%'";
	$where .=  "  OR  TBL.fk_type LIKE '%".$filter_data['general_search']."%'";
	 $where .= " ) ";
