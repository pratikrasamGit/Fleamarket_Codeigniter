...
{                   
	...
	**************/
    ...
    public function list()
    {
        ...
        $orderArray = array(  'id', 'first_name', 'birth_date', 'gender', 'location', 'email_id', 'password', 'social_id', 'social_type', 'profile_pic', 'is_social_image', 'city', );
        ...
        if($action == "update_data")
        {
            if(!empty($_POST))
            {
				...
				array(
				 ...
				 'is_social_image' => $this->input->post('is_social_image',true),
				 ...
				 'is_complete' => $this->input->post('is_complete',true),
				 'fcm_token' => $this->input->post('fcm_token',true),
				 'user_long' => $this->input->post('user_long',true),
