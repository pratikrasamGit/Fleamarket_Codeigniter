...
<body>
 ...
 <?php } ?>;" > -->
         <div class="container pt-5"  >
            <div class="section_heading justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center">
                    <span class="ml-3">
                    <a class="favorite favorite<?=$market->id?> <?php if($market->is_fav_market==1){ echo "active"; } ?>" href="javascript:void(0)" onclick="favourite(<?= $market->id ?>)">
                    ...
                    <ul class="nav gallery_img justify-content-between">
                        <?php
                            ...
                            foreach ($market->images as $keys => $values) {
                                if($is_visible == 1 || $keys == 0){ 
                        ?>
                                    <li class="nav-item active" height="170px">
                                        <a href="#">
                                            <img src="<?= $values->fullurl ?>" alt="" height="170px" style="border-radius: 20px;">
                                        </a>
                                    </li>
                        <?php
                                } else{
                        ?>
                                    <li class="nav-item lock" height="170px">
                                        <a href="#">
                                            <img src="<?php if(count($market->images) > 0){ echo $market->images[0]->fullurl; } ?>" alt="" height="170px">
                                        </a>
                                    </li>
                        ...
                        <!-- <li class="nav-item lock" height="170px">
                            <a href="#">
                                <img src="<?= base_url() ?>assets/img/gallery_list_img1.png" alt="" height="170px" style="border-radius: 20px;">
                            </a>
                        </li> -->
                    </ul>
                </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-between">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <ul class="d-flex information_list align-items-center">
                                    ...
                                    <div class="information_list_item"><?php $date=date_create($market->start_time);echo date_format($date,"H:i"); ?> - <?php $date2=date_create($market->end_time);echo date_format($date2,"H:i"); ?></div>
                                </ul>
                            </div>
                            <div class="col-sm-6">
                                <ul class="d-flex information_list align-items-center">
                ...
                <div class="col-lg-7 pt-4">
                    ...
                    <div class="py-3">
                        <p class="fs-14 fw-400"><?= mb_convert_encoding($market->description,"UTF-8","auto"); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container pt-4">
            <?php if($market->contact_person != '' || $market->contact_number != '' || $market->contact_email != ''){ ?>
            <div class="section_heading justify-content-between align-items-center">
                <h5 class="fs-30 fw-700"><?php echo $this->lang->line('contact');?></h5>
            </div>
            <div class="row align-items-center">
                <?php if($market->contact_person != ''){ ?>
                <div class="col-sm-6 col-lg-auto">
                    <ul class="nav justify-content-start details_page_contact_list align-items-center">
                        <li class="nav-item">
                            <img width="30" src="<?=base_url().$market_user->profile_pic?>" alt="">
                        </li>
                        <li class="nav-item">
                        <?php if($is_visible ==1){ 
