	...
	<div class="home_banner_area">
		<div class="container-big banner_inner">
			<div class="row align-items-center">
				...
				<div class="col-lg-7">
					<h2 class="fs-60 fw-700 text-center"><?php echo $this->lang->line('discover'); ?> <span class="text_success"><?php echo $this->lang->line('flea_Markets'); ?></span> <?php echo $this->lang->line('around_you'); ?> </h2>
			...
			<div class="row">
				...
				?>
					<div class="col-xl-3 col-md-6">
						<div class="explore_nearby_card img_bg_card" style="background-image: url(<?= $envalues['image'] ?>);">
					...
					<div class="col-xl-3 col-md-6">
						<div class="feature_market_card">
							<a href="<?= base_url() ?>market/<?= $mvalues->id ?>">
								<div class="img_bg_card mt-0" <?php if(!empty($mvalues->images)){ ?>style="background-image: url(<?= $mvalues->images[0]->fullurl ?>);" <?php } ?>>
									<div class="img_bg_card_content">
										<div class="d-flex-wrap justify-content-between align-items-center mb-2">
											...
											<div class="d-flex align-items-center">
												<span class="ml-3">
													<a class="favorite"  <?php if($is_fav_market==1){ echo "active"; } ?>" href="javascript:void(0)" onclick="favourite(<?= $mvalues->id ?>)">
										...
										<div class="d-flex-wrap justify-content-between align-items-center">
											<p class="fs-12 fw-500 m-0">
												...
												<?= $mvalues->start_time ?> - <?= $mvalues->end_time ?>
											</p>
											<p class="fs-12 fw-500 m-0">
												<span>
