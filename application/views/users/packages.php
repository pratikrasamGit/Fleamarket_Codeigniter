            ...
            <div class="row justify-content-center">
                <div class="col-sm-9 user_bdr_container">
                    <div class="section_heading justify-content-center">
                        <h4 class="fs-30 fw-800"><?php echo $this->lang->line('headpackage');?></h4>
                    </div>
                    ...
                    <div class="row align-items-center justify-content-center">
                                    ...
                                    <div class="package_card_body">
                                        ...
                                        <div class="text-center mt-3">
                                            ...
                                            <?php if($values->discount_msg){ 
													...
													<?php } } ?>
                                            <?php if($is_selected!=1){ ?>
                                            <button class="btn" type="button" onclick="packagetype('Package',<?= $values->id ?>,<?= $values->price ?>)"><?php echo $this->lang->line('buy_now');?></button>
                                            <?php } ?>
                        ...
                        <!-- <div class=" col-xl-5 col-sm-6">
                            <div class="package_card">
                                <div class="package_card_body">
                                    <h5 class="fs-20 fw-800 text-center">Platinum</h5>
                                    <ol>
                                        <li class="my-3">Create market</li>
                                        <li class="my-3">Text for the market</li>
                                        <li class="my-3">Save you markets</li>
                                        <li class="my-3">Upload 10 pictures</li>
                                        <li class="my-3">Stade place sales info</li>
                                        <li class="my-3">Favorite list</li>
                                        <li class="my-3">Upload video</li>
                                        <li class="my-3">Repeat market</li>
                                    </ol>
                                    <div class="text-center mt-3">
                                        <h5 class="fs-20 fw-800 ">39DKK - Per. Month</h5>
