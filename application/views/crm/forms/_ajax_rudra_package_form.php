...
<div class="form-group col-sm-6">
	<label>Package Name</label>
 	<input type="text"  name="package_name" class="form-control" value="<?= (!empty($form_data) ? $form_data->package_name : ''); ?>"   placeholder="Package Name" required  />
</div>
<div class="form-group col-sm-6">
...
<div class="form-group col-sm-12">
	<label>Package Description</label>
 	<textarea name="package_description" class="form-control" placeholder="Package Description" required ><?= (!empty($form_data) ? $form_data->package_description : ''); ?></textarea>
</div>
<div class="form-group col-sm-12">
